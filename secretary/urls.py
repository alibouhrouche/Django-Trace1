...
from .views import projects_view, edit_project_view, new_project_view, clients_view, edit_client_view, new_client_view, \
    delete_project_view, delete_client_view
...
urlpatterns = [
    ...
    path("projects/delete/<pk>", view=delete_project_view, name="delete_project"),
    ...
    path("clients/delete/<pk>", view=delete_client_view, name="delete_client")
]
